...
export default function LoginPage() {
  ...
  const onValidSubmit = async (_data: LoginForm) => {
    // Temporary fake auth for now, when we have a real backend, we will call the login API here and set cookie based on response.:
    // middleware checks this cookie to decide if user is logged in.
    document.cookie = "token=dummy; path=/";

    // After setting cookie, go to dashboard.
